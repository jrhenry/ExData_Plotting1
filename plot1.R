...
png(filename = "plot1.png", width = 480, height = 480, units = "px", res = NA, bg= "white")

# Builds a histogram ofr the global acvtive power in kilowatts
hist(dset$Global_active_power, col = "red", main = "Global Active Power", 
